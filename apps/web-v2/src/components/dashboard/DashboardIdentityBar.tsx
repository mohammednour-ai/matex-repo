...
export function DashboardIdentityBar() {
  return (
    <section
      className="dashboard-identity-bar relative overflow-hidden rounded-2xl border border-line bg-[linear-gradient(135deg,#1a1f27,#20262f_45%,#15191f_100%)] px-5 py-5 shadow-[0_24px_60px_-30px_rgba(0,0,0,0.55)] ring-1 ring-white/5 sm:px-7 sm:py-6"
    ...
    >
      ...
      <div className="relative min-w-0">
        ...
        >
          ...
          <span className="mt-1 block text-sm font-light uppercase tracking-[0.24em] text-fg-muted sm:text-base">
            EXCHANGE
          </span>
        </h2>
