    ...
    <div className="dashboard-page">
      <div className="dashboard-hero">
        <div className="dashboard-hero-grid">
          <div className="h-7 w-32 rounded-full bg-night-800/60 animate-pulse" />
          <div className="mt-4 h-9 w-3/4 max-w-lg rounded-lg bg-night-800/60 animate-pulse" />
          <div className="mt-3 h-4 w-2/3 max-w-md rounded-lg bg-night-800/40 animate-pulse" />
      ...
      <div className="dashboard-module-grid">
        <div className="card p-6">
          ...
          <div className="mt-4 space-y-3">
            {[0, 1, 2, 3].map((i) => (
              <div key={i} className="h-12 rounded-xl bg-night-800/40 animate-pulse" />
            ))}
          </div>
        </div>
        <div className="card p-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
            {[0, 1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-32 rounded-card bg-night-800/40 animate-pulse" />
            ))}
          </div>
        </div>
      </div>
