  ...
  return (
    <Modal open={open} onClose={onClose} title="Register for Auction" size="md">
      <div className="space-y-4">
        ...
        {error && (
          <p className="text-xs text-red-600 flex items-center gap-1 bg-danger-500/10 p-2 rounded-lg">
  ...
  return (
    <div className="bg-night-850 border border-night-700 rounded-xl p-4 space-y-3">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <div className="flex items-center gap-1 bg-success-500/10 text-success-400 text-xs px-2 py-0.5 rounded-full font-medium">
          <ShieldCheck size={11} />
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div>
            <div className="flex items-start justify-between gap-3 flex-wrap">
              ...
              {/* Share / Report */}
              <div className="flex items-center gap-2">
                <button className="p-2 rounded-lg border border-night-700 text-night-300 hover:bg-night-900 transition-colors" aria-label="Share">
                  <Share2 size={15} />
                </button>
                <button className="p-2 rounded-lg border border-night-700 text-night-300 hover:bg-night-900 transition-colors" aria-label="Report">
                  <Flag size={15} />
                </button>
              </div>
            </div>
          ...
          <div className={clsx(
            ...
            {listing.sale_mode === "fixed" && (
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  <p className="text-sm text-success-400 font-medium">Fixed Price</p>
            ...
            {listing.sale_mode === "auction" && (
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  <p className="text-sm text-warning-400 font-medium">Live Auction Session</p>
                  {listing.auction_session_date && (
                    <>
                      <p className="text-base font-bold text-warning-400 mt-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-sm text-warning-400">Starts in:</span>
                        <CountdownTimer targetDate={listing.auction_session_date} className="text-warning-400" />
                      </div>
                    </>
                  )}
                </div>
